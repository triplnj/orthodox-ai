...
export const CURATED_PATRISTIC_DOCUMENTS:
  CuratedPatristicDocument[] = [
    ...
    {
      key: "gregory-nazianzen-oration-29",
      ...
      workTitle: "Third Theological Oration (Oration 29) - On the Son",
      workAliases: ["theological orations", "oration 29", "third theological oration", "теолошке беседе", "богословске беседе"],
      subjects: ["trinity", "holy trinity", "trojica", "sveta trojica", "тројица", "света тројица", "godhead", "father", "son"],
      sourceUrl: "https://www.newadvent.org/fathers/310229.htm",
      sourceName: "New Advent - Gregory Nazianzen, Third Theological Oration (Oration 29)",
      sourceLanguage: "English",
      documentType: "TRANSLATION",
      verificationStatus: "CURATED_PATRISTIC_TEXT_REPOSITORY",
    },
    ...
    {
      key: "gregory-nazianzen-oration-31",
      authorName: "St. Gregory Nazianzen",
      authorAliases: ["gregory nazianzen", "gregory of nazianzus", "gregory the theologian", "grigorije bogoslov", "sveti grigorije bogoslov", "григорије богослов", "свети григорије богослов"],
      workTitle: "Fifth Theological Oration (Oration 31) - On the Holy Spirit",
      workAliases: ["theological orations", "oration 31", "fifth theological oration", "теолошке беседе", "богословске беседе"],
      subjects: ["trinity", "holy trinity", "trojica", "sveta trojica", "тројица", "света тројица", "godhead", "holy spirit", "свети дух"],
      sourceUrl: "https://www.newadvent.org/fathers/310231.htm",
      sourceName: "New Advent - Gregory Nazianzen, Fifth Theological Oration (Oration 31)",
      sourceLanguage: "English",
      documentType: "TRANSLATION",
      verificationStatus: "CURATED_PATRISTIC_TEXT_REPOSITORY",
    },
